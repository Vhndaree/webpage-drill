...
func TestHTMLParser(t *testing.T) {
	...
	t.Log("HTML Links Counter")
	{
		t.Run("Link", func(t *testing.T) {
			ExpectEqual(t, util.Links("https://www.w3.org/", dummyHTML1), model.Link{51, 7, 1})
			ExpectEqual(t, util.Links("https://www.tic.com/", dummyHTML2), model.Link{3, 9, 0})
			ExpectEqual(t, util.Links("https://www.tic.com/", dummyHTML3), model.Link{3, 9, 0})
		})
	}
